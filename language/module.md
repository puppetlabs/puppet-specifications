...
| `/LICENSE`            | The `/LICENSE` file, with an optional file suffix, SHOULD be included in the module. If the file is present, it MUST match `/metadata.json`'s license field. |
