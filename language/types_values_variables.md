...
**In this version of the specification strict variable lookup is optional (controlled by a feature switch). It is not on by default in Puppet 4.x onwards, but it is mandatory in Puppet 8.0.**
